...
INSERT INTO subscriptions (plan, start_date, end_date, price, user_id) VALUES
                                                                           ('MONTHLY', '2026-05-01', '2026-06-01', 49.99, 2),
                                                                           ('YEARLY', '2026-01-01', '2027-01-01', 399.99, 3),
                                                                           ('MONTHLY', '2026-05-01', '2026-06-01', 49.99, 4);
...
INSERT INTO workouts (title, description, scheduled_at, duration_minutes, trainer_id) VALUES
                                                                                          ...
                                                                                          ('Advanced Yoga', 'Advanced yoga poses and breathing', '2026-05-16 09:00:00', 60, 1);
